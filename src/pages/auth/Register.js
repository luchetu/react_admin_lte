...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        Auth.register({ email: email, password: password.password }, (response) => {
            ...
            <div className="login-box">
                ...
                <div className='card'>
                    <div className=" card-body login-card-body">
                        <p className='login-box-msg'>Create an account and try to login</p>
                                ...
                                <div className="col-xs-4">
                                    ...
                                    <p >
                                        <NavLink
                                            ...
                                            to="/login" class="text-center">Go to Login
                                        </NavLink>
                                    </p>
                                </div>
                            </div>
